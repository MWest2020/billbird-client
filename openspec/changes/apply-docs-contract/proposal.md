...
billbird-client heeft 3 docs-pagina's zonder contract; wave 2.
...
- `cli.md`, `mcp.md` -> `reference/`; `release.md` -> `how-to/`;
  stubs achterlaten. `docs/index.md` nieuw uit README.
- Licentie is MIT: NIET wijzigen; bewuste afwijking, staat in de inventaris.
